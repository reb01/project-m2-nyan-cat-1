...
class Enemy {
    ...
    constructor(theRoot, enemySpot) {
        ...
        this.domElement.src =
            "https://raw.githubusercontent.com/reb01/photos/master/hillary-clinton-9251306-2-402%20(1).jpg";
        ...
        this.speed = Math.random() / 4 + 0.15;

        if (this.speed < 0.26 && this.speed > 0.24) {
            this.domElement.src =
                "https://raw.githubusercontent.com/reb01/photos/master/Blog_KidsandMasks1.jpg";
        } else if (this.speed < 0.3 && this.speed > 0.27) {
            this.domElement.src =
                "https://raw.githubusercontent.com/reb01/photos/master/biden%20(1).jpg";
        } else if (this.speed < 0.25) {
            this.domElement.src =
                "https://raw.githubusercontent.com/reb01/photos/master/virus%20(2).jpg";
        } else if (this.speed > 0.29) {
            this.domElement.src =
                "https://raw.githubusercontent.com/reb01/photos/master/hillary-clinton-9251306-2-402%20(1).jpg";
        }
    }
