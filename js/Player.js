...
class Player {
    ...
    constructor(root) {
        ...
        this.domElement.src =
            "https://raw.githubusercontent.com/reb01/photos/master/trump%20face%20(1).jpg";
        ...
        this.speechBubble = document.createElement("img");
        this.speechBubble.style.display = "none";
        this.speechBubble.src =
            "https://raw.githubusercontent.com/reb01/photos/master/TrumpSpeechBubble.jpg";
        this.speechBubble.style.position = "absolute";
        this.speechBubble.style.left = `${this.x + 100}px`;
        this.speechBubble.style.top = `${y - 120}px`;
        this.speechBubble.style.zIndex = "100";
        root.appendChild(this.speechBubble);
    }
    ...
    moveUp() {
        ...
        this.speechBubble.style.top = `${this.y - 120}px`;
    }
